...
export class Instrument {
    ...
    public toJsonObject(): Object {
        ...
        if (this.type == InstrumentType.noise) {
            ...
            // This is here so that we don't hit the unrecognized instrument type exception below.
    ...
    public toBase64String(): string {
        ...
        for (let channelIndex: number = 0; channelIndex < this.getChannelCount(); channelIndex++) {
            for (let i: number = 0; i < this.channels[channelIndex].instruments.length; i++) {
                ...
                // The list of enabled effects is represented as a 18-bit bitfield using three six-bit characters.
                buffer.push(
                    SongTagCode.effects,
